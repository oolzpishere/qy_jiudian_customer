module Admin
  class RoomType
    # @date_rooms
    # {"room_type1" => {"date" => {rooms: rooms_num, changed: true},
    #                   "date2" => {rooms: rooms_num2, changed: true},...},
    # "room_type2" => {...}}
    ...
    def change_rooms(room_type_name_eng, date_range_arr, change_rooms)
      return false unless check_available(room_type_name_eng, date_range_arr, change_rooms)
    ...
    def change_rooms!(room_type_name_eng, date_range_arr, change_rooms)
      change_rooms(room_type_name_eng, date_range_arr, change_rooms)
      apply_changes(room_type_name_eng, date_range_arr)
    end
    ...
    def check_available(room_type_name_eng, date_range_arr, change_rooms)
      date_range_arr.each do |date|
    ...
    def sort_dates_arr(dates_arr, order: :inc)
    ...
    def find_date_room_rec(date)
      ...
      hotel_room_type_rec.date_rooms.find {|dr| dr.date == date}
    end
