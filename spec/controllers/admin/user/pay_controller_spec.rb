...
RSpec.describe Admin::User::PayController, type: :controller do
  ...
  describe "#wx_pay" do
    ...
    it "post :wx_pay, create Payment and WxPayment" do
      ...
      expect(Pay::Payment.count).to eq(1)
      expect(Pay::WxPayment.count).to eq(1)
      Pay::WxPayment.first.attributes.slice("total_fee")
    end
    ...
    it "post :wx_pay, right WxPayment" do
      ...
      created_wx_payment = Pay::WxPayment.first.attributes.slice("total_fee", "payment_id")
